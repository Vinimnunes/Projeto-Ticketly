...
<head>
    ...
    <title>Sunset</title>
    <link rel="stylesheet" href="style_beauty2.css">
</head>
...
<body>
    ...
    <div class="flex-container" id="home">
        <div class="pericles">
            <img src="../Fotos/beautyfair.png" style="border-radius: 30px !important;"
    ...
    <div class="titulo-info">
        <h1> BEAUTY FAIR - 24/11/23</h1>
        <h4> Sexta-Feira às 17h00 | 24 de Novembro </h4>
        <h4> Teatro Guararapes - Olinda, PE</h4>
    </div>
    <div class="todas-info principal">
        <div class="col col-esq">
            <div class="info-evento">
                ...
                <h5>Sobre:</h5>
                VEM AÍ! MAIS UMA EDIÇÃO DA BEAUTY FAIR! A FEIRA INTERNACIONAL DE BELEZA PROFISSIONAL MAIS AGUARDADA DA CIDADE!
                <br>
                UM DIA DE PALESTRA E MUITO CONHECIEMNTO, COM OS MAIS RENOMADOS PROFISSIONAIS DE BELEZA DO PAÍS, VEM CONFERIR!
                <br>
                <br>
                📅 DATA: 24 DE NOVEMBRO DE 2023 (SEXTA-FEIRA) <br><br>
                ⏰ HORÁRIO: 17H00 <br><br>
                📍 LOCAL: TEATRO GUARARAPES - (CENTRO DE CONVEÇÔES DE PERNAMBUCO, OLINDA - PE) 
                <br><br>
                
                <h5>Participantes principais:</h5>
                &bull; ISABEL RIBEIRO <br>
                &bull; PAULA FENTY E OUTROS <br><br>
                GARANTA SEU LUGAR NESSE EVENTO INCRÍVEL! INGRESSOS JÁ À VENDA EM NOSSO SITE OU NOS PONTOS AUTORIZADOS.
                <br><br>
                PREPARE-SE PARA VIVER MOMENTOS INESQUECÍVEIS! MARQUE NA AGENDA E CONVIDE SEUS AMIGOS PARA MAIS UM FIM DE SEMANA DE CONHECIMENTO. ESPERAMOS POR VOCÊ!
                <br><br>
