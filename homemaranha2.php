...
<head>
    ...
    <title>Sunset</title>
    <link rel="stylesheet" href="style_homemaranha2.css">
</head>
...
<body>
    ...
    <div class="flex-container" id="home">
        <div class="pericles">
            <img src="../Fotos/homemaranha.png" style="border-radius: 30px !important;"
    ...
    <div class="titulo-info">
        <h1> HOMEM-ARANHA NO ARANHAVERSO  - 17/09/2023</h1>
        <h4>Domingo às 16h00 | 17 de Setembro</h4>
    ...
    <div class="todas-info principal">
        <div class="col col-esq">
            <div class="info-evento">
                ...
                <br><br>
                APRESENTAMOS, EM UMA TARDE MÁGICA E REPLETA DE AÇÃO E AVENTURAS A ADAPTÇÃO DO LONGA MAIS QUERIDO DOS SUPER HERÓIS: "HOMEM-ARANHA"! 
                <br><br>
                📅 DATA: 17 DE SETEMBRO DE 2023 (DOMINGO)<br><br>
                ⏰ HORÁRIO: 16H00<br><br>
                📍 LOCAL: TEATRO BOA VISTA (RUA DOM BOSCO, 551 -  RECIFE, PE) 
                <br><br>
                TESTEMUNHE AS ACROBACIAS ESPETACULARES, OS VILÕES ICÔNICOS E A CORAGEM DO HOMEM ARANHA BALANÇANDO PELA CIDADE ATRÁS DE COMBATER O CRIME. UMA EXPERIÊNCIA ÚNICA QUE VAI ALÉM DA TELAS!
                <BR><BR>
                ...
                <div class="box-ingressos">
                    ...
                    <div class="ingressos">
                        ...
                        <div class="class-indicativa">
                            <p>
                                <!-- NÃO TIREM O P, POIS TIRAR DEIXA A BARRA MENOR-->
                            </p>
                        </div>
                    </div>
                    <fieldset>
    ...
    <script src="homemaranha.js"></script>
