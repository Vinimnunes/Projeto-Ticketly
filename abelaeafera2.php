...
<head>
    ...
    <title>A Bela e a Fera</title>
    <link rel="stylesheet" href="style_abelaeafera2.css">
</head>
...
<body>
    ...
    <div class="flex-container" id="home">
        <div class="pericles">
            <img src="../Fotos/abelaeafera.png" style="border-radius: 30px !important;" class="mx-auto d-block img-fluid evento"
    ...
    <div class="titulo-info">
        <h1>A BELA E A FERA (E OUTRAS HISTÓRIAS) - 09/09/2023</h1>
        <h4>Sábado às 16h30 | 09 de Setembro</h4>
        <h4>Teatro Barreto Júnior - Recife, PE</h4>
    </div>
    <div class="todas-info principal">
        <div class="col col-esq">
            <div class="info-evento">
                ...
                <h5>Sobre:</h5>
                NÃO PERCA A PEÇA TEATRAL MAIS AGUARDADA PELOS PEQUENOS!
                <br><br>
                APRESENTAMOS, EM UMA TARDE MÁGICA E REPLETA DE ENCANTO A IMPERDÍVEL ADAPTÇÃO TEATRAL DE "A BELA E A
                FERA"!
                <br><br>
                📅 DATA: 09 DE SETEMBRO DE 2023 (SÁBADO)<br><br>
                ⏰ HORÁRIO: 16H30<br><br>
                📍 LOCAL: TEATRO BARRETO JÚNIOR (RECIFE - PE)
                <br><br>
                TESTEMUNHE O CLÁSSIO DE A BELA E A FERA GANHAR A VIDA NO PALCO DO BARRETO JÚNIOR EM RECIFE. VIAJE PELO
                MUNDO FANTÁSTICO DE BELA, CHEIO DE AVENTURAS E ROMANCE!
                <BR><BR>
                GARANTA SEU LUGAR NESSA FESTA INCRÍVEL! INGRESSOS JÁ À VENDA EM NOSSO SITE OU NOS PONTOS AUTORIZADOS.
                <br><br>
                PREPARE-SE PARA VIVER MOMENTOS INESQUECÍVEIS! MARQUE NA AGENDA E CONVIDE SEUS AMIGOS PARA ESSA TARDE
                CHEIA DE MÚSICA E DIVERSÃO. ESPERAMOS POR VOCÊ!
                <br><br>
                ...
                <div class="box-ingressos">
                    ...
                    <div class="ingressos">
                        ...
                        <div class="class-indicativa">
                            <p>
                                <!-- NÃO TIREM O P, POIS SENÃO A BARRA FICA MENOR-->
                            </p>
                        </div>
                    </div>
                    <fieldset>
                    ...
                    <fieldset>
                        <div class="opcao-ingresso">
                            ...
                            <h2>
                                <span class="caps">MEIA</span>
                                <br>
                                Mediante comprovação de meia entrada e 1Kg de alimento
                            </h2>
                            <p></p>
                            <div class="opcao-valor">
    ...
    <script src="abelaeafera.js"></script>
