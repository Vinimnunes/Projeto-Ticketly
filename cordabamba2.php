...
<head>
    ...
    <title>A Noite Da Corda Bamba</title>
    <link rel="stylesheet" href="style_cordabamba2.css">
</head>
...
<body>
    ...
    <div class="flex-container" id="home">
        <div class="pericles">
            <img src="../Fotos/anoitedacordabamba.png" style="border-radius: 30px !important;" class="mx-auto d-block img-fluid evento"
    ...
    <div class="titulo-info">
        <h1> A NOITE DA CORDA BAMBA</h1>
        <h4> Sexta-Feira ás 20h30 | 02 de Setembro </h4>
        <h4> BAR DO CUSCUZ - AV. CONSELHEIRO AGUIAR, BOA VIAGEM - PE</h4>
    </div>
    <div class="todas-info principal">
        <div class="col col-esq">
            <div class="info-evento">
                ...
                <h5>Sobre:</h5>
                ALEX ALVES APRESENTA: A NOITE DA CORDA BAMBA!
                <br>
                DANDO INÍCIO A EDIÇÃO, ALEX ALVES E COMPANHIA DE COMEDIANTES SE EQUILIBRAM E DESENVOLVEM PIADAS
                IMPROVISADAS COM TEMAS SUGERIDOS PELA PLANTEIA. A FARRA TA COMPLETA, VEM CONFERIR!
                <br>
                <br>
                📅 DATA:02 DE SETEMBRO DE 2023 (SÁBADO)<br><br>
                ⏰ HORÁRIO: 20H30 <br><br>
                📍 LOCAL: BAR DO CUSCUZ - (AV. CONSELHEIRO AGUIAR, BOA VIAGEM - PE)
                <br><br>

                <h5>Atrações principais:</h5>
                &bull; ALEX ALVES <br><br>
                &bull; MARCÍLIO RODRIGUES <br><br>
                &bull; DAVI VILLA REAL <br><br>
                &bull; MICHELE FELIX <br><br>
                GARANTA SEU LUGAR NESSA MISTURA INCRÍVEL! INGRESSOS JÁ À VENDA EM NOSSO SITE OU NOS PONTOS AUTORIZADOS.
                <br><br>
                ...
                <div class="box-ingressos">
                    ...
                    <fieldset>
                        <div class="opcao-ingresso">
                            ...
                            <h2>
                                <span class="caps">REGULAR (MEIA)</span>
                                <br>
                    ...
                    <fieldset>
                        <div class="opcao-ingresso">
                            ...
                            <h2>
                                <span class="caps">REGULAR (SOCIAL)</span>
                                <br>
                            </h2>
                            <p></p>
                            <div class="opcao-valor">
    ...
    <script src="cordabamba.js"></script>
