...
<head>
    ...
    <title>Sunset</title>
    <link rel="stylesheet" href="style_capiba2.css">
</head>
...
<body>
    ...
    <div class="flex-container" id="home">
        <div class="pericles">
            <img src="../Fotos/capiba.png" style="border-radius: 30px !important;"
    ...
    <div class="titulo-info">
        <h1> CAPIBA (PELAS RUAS EU VOU) - 07/09/2023</h1>
        <h4>Quinta-feira às 19h00 | 07 de Setembro</h4>
        <h4>Teatro Boa Vista - Recife, PE</h4>
    </div>
    <div class="todas-info principal">
        <div class="col col-esq">
            <div class="info-evento">
                ...
                <h5>Sobre:</h5>
                MINISTÉRIO DA CULTURA APRESENTA: "CABIPA - PELAS RUAS EU VOU", UM ESPETÁCULO QUE REVERENCIA TODA NOSSA BELA TRADIÇÃO! 
                <br><br>
                APRESENTAMOS, NESTA QUINTA-FEIRA DEDICADA Á ARTE E Á TRADIÇÃO, UM ESPETÁCULO DE CULTURA MUSICAL MERGULHADA NA VIDA E NA OBRA DE UM DOS GRANDES MESTRES DA MÚSICA PERNAMBUCANA.
                <br><br>
                📅 DATA: 07 DE SETEMBRO DE 2023 (QUINTA-FEIRA)<br><br>
                ⏰ HORÁRIO: 19H00<br><br>
                📍 LOCAL: TEATRO BOA VISTA (RUA DOM BOSCO, 551 -  RECIFE, PE) 
                <br><br>
                "CAPIBA" PROMETE ENVOLVER O PÚBLICO COM MÚSICAS ENCANTADORAS, HISTÓRIAS EMOCIONANTES E A ESSÊNCIA ÚNICA DA CULTURA DE PERNAMBUCO! NÃO DEIXE DE CONFERIR!
                <BR><BR>
                ...
                <div class="box-ingressos">
                    ...
                    <div class="ingressos">
                        ...
                        <div class="class-indicativa">
                            <p>
                                <!-- NÃO TIRE O P, POIS IRÁ FAZER A BARRA FICAR MENOR-->
                            </p>
                        </div>
                    </div>
                    <fieldset>
