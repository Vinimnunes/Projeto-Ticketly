...
<head>
    ...
    <title>Sunset</title>
    <link rel="stylesheet" href="style_sunset2.css">
...
<body>
    ...
    <div class="flex-container" id="home">
        <div class="pericles">
            <img src="../Fotos/umdocencontro.png" style="border-radius: 30px !important;"
    ...
    <div class="titulo-info">
        <h1>PÉRICLES SUNSET - 17/09/2023</h1>
        <h4>Domingo às 14h30 | 17 de Setembro</h4>
        <h4>Arena Pernambuco - Recife, PE</h4>
    </div>
    <div class="todas-info principal">
        <div class="col col-esq">
            <div class="info-evento">
                ...
                - Club Estrela
                <br>
                Estrada da cumbica, 3561 Jd Aracati - SP
                <br>
                <br>
                <h5>Informações Importantes:</h5>
                Observe atentamente as regras sanitárias do seu evento.
                <br>
                <br>
                COMPREI O INGRESSO PELO SITE / APLICATIVO, COMO VOU ENTRAR NO EVENTO?
                <br>
                ...
                <br>
                <br>
                Você também pode consultar outras dúvidas sobre ingressos na Central de Ajuda Ingressos.
                <br>
                <br>
                - O ingresso é válido apenas para o local e setor indicado.
                <br>
                <br>
                - É proibido o acesso às dependências do evento de pessoas portando armas de qualquer tipo, caixas,
                foguetes, objetos cortantes ou contundentes ou outros que possam causar ferimentos a terceiros.
                <br>
                <br>
                - A entrada de alimentos e bebidas de quaisquer natureza é proibida.
                <br>
                <br>
                - Proibido o consumo de bebidas alcoólicas por menores de idade.
                <br>
                <br>
                - Observe a classificação do evento.
                <br>
                <br>
                - O titular do ingresso declara expressamente aceitar que sua imagem e áudio possam ser captados e
                ...
                <br>
                <br>
                - Não nos responsabilizamos por ingressos comprados a terceiros, ou seja, use sempre os canais oficias
                do evento.
                <br>
                <br>
                - Desconfie sempre de ingressos abaixo do valor de mercado e muita facilidade na compra.
                <br>
                <br>
                - Não compre ingressos a CAMBISTAS.
                <br>
                <br>
                - O ingresso é um título ao portador. Em caso de roubo, furto ou fenômeno da natureza, não reimprimimos
                ingresso.
                <br>
                <br>
                - Não dobre o ingresso e proteja o código de barra. Guarde em um local seco e seguro.
                <br>
                <br>
                <h5>Classificação:</h5>
                18 Anos
                ...
                <div class="box-ingressos">
                    ...
                    <fieldset>
                        <div class="opcao-ingresso">
                            <div class="info-header">
                                <span class="info-esq">3º Lote</span>
                                <span class="info-dir">Sub Total</span>
                            </div>
                            <h2>
                                <span class="caps">FRONT (MEIA)</span>
                                <br>
                    ...
                    <fieldset>
                        <div class="opcao-ingresso">
                            ...
                            <h2>
                                <span class="caps">FRONT (SOCIAL)</span>
                                <br>
                                Mediante doação de 1kg de alimento
                            </h2>
                            <p></p>
                            <div class="opcao-valor">
                    ...
                    <fieldset>
                        <div class="opcao-ingresso">
                            ...
                            <h2>
                                <span class="caps">VIP (SOCIAL)</span>
                                <br>
                                Mediante doação de 1kg de alimento
                            </h2>
                            <p></p>
                    ...
                    <fieldset>
                        <div class="opcao-ingresso">
                            ...
                            <h2>
                                <span class="caps">OPEN BAR (MEIA)</span>
                                <br>
                                Mediante comprovação de meia entrada
                            </h2>
                            <p></p>
                            <div class="opcao-valor">
                                <select class="escolha" name="Quant5" id="Quant5" onchange="javascript:cItems5()">
                                    <option value="0">Quant.</option>
                                    <option value="1">1</option>
                                    <option value="2">2</option>
                                    <option value="3">3</option>
                                ...
                                <div class="subtotal-valor">
                                    <span id="subtotal5" class="valor-dir">R$ 0.00</span>
                                </div>
                            </div>
                        </div>
                    </fieldset>
                    <fieldset>
                        <div class="opcao-ingresso">
                            ...
                            <h2>
                                <span class="caps">OPEN BAR (SOCIAL)</span>
                                <br>
                                Mediante doação de 1kg de alimento
                            </h2>
                            <p></p>
                            <div class="opcao-valor">
                                <select class="escolha" name="Quant6" id="Quant6" onchange="javascript:cItems6()">
                                    <option value="0">Quant.</option>
                                    <option value="1">1</option>
                                    <option value="2">2</option>
                                    <option value="3">3</option>
                                ...
                                <div class="subtotal-valor">
                                    <span id="subtotal6" class="valor-dir">R$ 0.00</span>
                                </div>
                            </div>
                        </div>
                    </fieldset>
